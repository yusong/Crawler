(function() {
	 ...
	 */
	Crawler.prototype.pull = function(callback) {
		var _self = this;
		...
		var pullJob = function(callback) {
			_self.queue.lpop(_self.config.name, function(err, data){
				...
				if(!data) console.log('No data in redis');
		...
		var pushJob2Redis = function(callback) {
			var client = Mongo.Db(_self.config.tasks_db, new Mongo.Server('127.0.0.1', '27017'), {fsync:true});
	...
	Crawler.prototype.ack = function(tasks, callback) {
		...
		}, function(truthValue){ callback(true); }); // End of Iterating All Tasks
	};

	exports.Crawler = Crawler;
	// exports.ack = Crawler.ack;
